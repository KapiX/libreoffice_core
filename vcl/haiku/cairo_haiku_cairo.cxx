...
namespace cairo
{
     ...
     **/
    HaikuSurface::HaikuSurface(const CairoSurfaceSharedPtr& pSurface)
        : mpGraphics(nullptr)
        , cr(nullptr)
        , mpSurface(pSurface)
    {}
     ...
     **/
    HaikuSurface::HaikuSurface(const HaikuSalGraphics* pGraphics, int x, int y, int width, int height)
     ...
     **/
    CairoSharedPtr HaikuSurface::getCairo() const
    {
     ...
     **/
    SurfaceSharedPtr HaikuSurface::getSimilar(int cairo_content_type, int width, int height ) const
    {
